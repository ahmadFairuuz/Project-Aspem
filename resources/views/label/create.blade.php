...
<div class="container-fluid px-4">
    <h1 class="mt-4">Tambah Data Aspem</h1>
        ...
        <div class="card-body">
            <form action="{{ route('label.create') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('register_perkara') is-invalid @enderror" name="register_perkara" value="{{ old('register_perkara') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('barang_bukti') is-invalid @enderror" name="barang_bukti" value="{{ old('barang_bukti') }}">
                    @error('barang_bukti')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" class="form-control @error('tanggal_barbuk') is-invalid @enderror" name="tanggal_barbuk" value="{{ old('tanggal_barbuk') }}">
